                    ...
                    <table class="table table-stripped toggle-arrow-tiny" data-sort="false">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$list->DOB}}</td>
                                <td>@if(!empty($list->school_id)) {{$list->school->name}} @endif</td>
                                <td>@if(!empty($list->grade_id)) {{$list->grade->name}} @endif</td>
                                <td>@if(!empty($list->user)){{$list->user->wx_name}}@endif</td>
                                <td>@if(!empty($list->user)){{$list->user->name}}@endif</td>
                                <td>@if(!empty($list->user)){{$list->user->phone}}@endif</td>
                                <td><button class="btn btn-danger  btn-xs" data-form="edit-model" data-toggle="modal" data-target="#formModal"
                                            data-id="{{$list->id}}"
                                            data-name="{{$list->name}}"
                                            data-sex="{{$list->sex}}"
                                            data-DOB="{{$list->DOB}}"
