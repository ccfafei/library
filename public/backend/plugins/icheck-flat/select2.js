...
(function ($, undefined) {
    ...
    function local(options) {
        ...
        if (dataItem.text) {
            ...
            if (!$.isFunction(text)) {
                dataText = dataItem.text; // we need to school this in a separate variable because in the next step data gets reset and data.text is no longer available
    ...
    function defaultTokenizer(input, selection, selectCallback, opts) {
        var original = input, // school the original so we can compare and know if we need to tell the search to update its text
